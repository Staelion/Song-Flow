		...
		<>
			<div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
				...
				<div className="flex w-full justify-center">
					<div className=" min-h-full w-[600px] max-w-full flex-col items-center justify-center py-6 sm:px-6 lg:px-4">
						<Tabs
							fullWidth={false}
							size="lg"
								...
								<Card className=" max-w-full">
									<CardBody className="w-full overflow-hidden bg-mainorange-500 px-6 py-6 shadow sm:rounded-lg sm:px-12">
										<form className="space-y-6" action="#" method="POST">
											...
											<div className={'font-semibold text-mainorange-900'}>
