...
function Flashcard(props) {
	return (
		<div className={'relative w-auto '}>
			...
			{/*<div className="everythingflashcard">*/}
			{/*	<div className="swiper mySwiper slide-container">*/}
			...
			{/*								Importez vos donnees d’écoutes spotify*/}
			{/*							</h4>*/}
			{/*							<p className="description">*/}
			{/*								Afin que nous puissions vous créer une playlist 100*/}
			{/*								personnalisée, importez facilement vos donnés d’écoutes*/}
			{/*								récentes !*/}
			{/*							</p>*/}

			{/*							<button className="cardbutton">*/}
			{/*								<a href="importation_donnees.html">En Savoir Plus</a>*/}
			{/*							</button>*/}
			{/*						</div>*/}
			{/*					</div>*/}
			{/*				</div>*/}
			...
			{/*						<div className="card-content">*/}
			{/*							<h4 className="cardtitle">*/}
			{/*								Plusieurs options de personnalisation de votre playlist*/}
			{/*							</h4>*/}
			{/*							<p className="description">*/}
			{/*								Choisisez parmi les options proposés afin de nous dire*/}
			{/*								avec précision ce que vous souhaitez retrouver dans votre*/}
			{/*								playlist !*/}
			{/*							</p>*/}
			{/*						</div>*/}
			{/*					</div>*/}
			...
			{/*						<div className="card-content">*/}
			{/*							<h4 className="cardtitle">*/}
			{/*								Gère ta playlist avant de la récupérery*/}
			{/*							</h4>*/}
			{/*							<p className="description">*/}
			{/*								Utilise les options d’ecoute d’un extrait du son et les*/}
			{/*								option de remplacement afin de séléctionner les titres que*/}
			{/*								tu veux garder ou non dans ta playlist customisée.*/}
			{/*							</p>*/}
			{/*						</div>*/}
			{/*					</div>*/}
			{/*				</div>*/}
			...
			{/*						<div className="card-content">*/}
			{/*							<h4 className="cardtitle">*/}
			{/*								Partage tes découvertes musicales et vote pour les*/}
			{/*								meilleures découvertes*/}
			{/*							</h4>*/}
			{/*							<p className="description">*/}
			{/*								Grace a l’onglet communautaire, découvre encore plus de*/}
			{/*								pépites musicales en partagant et en votant pour les*/}
			{/*								meilleurs partages des autres fans de musique !*/}
			{/*							</p>*/}

			{/*							<button className="cardbutton">*/}
			{/*								<a href="forum_communautaire.html">En Savoir Plus</a>*/}
			{/*							</button>*/}
			{/*						</div>*/}
			{/*					</div>*/}
			{/*				</div>*/}
			...
			{/*						<div className="card-content">*/}
			{/*							<h4 className="cardtitle">*/}
			{/*								Propose nous des petits artistes a exposer dans notre*/}
			{/*								tremplin d’artistes*/}
			{/*							</h4>*/}
			{/*							<p className="description">*/}
			{/*								Fais nous découvrir tes créations oux celles d’un artiste*/}
			{/*								que tu voudrais mettre en avant, ce sera peut-être lui la*/}
			{/*								prochaine star !*/}
			{/*							</p>*/}

			{/*							<button className="cardbutton">*/}
			{/*								<a href="tremplin_artistes.html">En Savoir Plus</a>*/}
			{/*							</button>*/}
			{/*						</div>*/}
			{/*					</div>*/}
			{/*				</div>*/}
